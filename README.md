...
server-side financial redaction.
...
[the Phase 5 guide](docs/phase-5.md), [the Phase 6 guide](docs/phase-6.md), and
...
corresponding verification documents, including [Phase 6 verification](docs/phase-6-verification.md).
